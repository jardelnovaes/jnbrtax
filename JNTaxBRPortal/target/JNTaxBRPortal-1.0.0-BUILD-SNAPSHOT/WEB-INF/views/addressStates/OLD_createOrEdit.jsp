  ...
  <form:form method="POST" modelAttribute="item" action="${action}" cssClass="form-horizontal">  	  
	<div class="row">			
		<div class="form-group">
		  <label for="id" class="col-sm-2 control-label">UF</label>
		  <div class="col-sm-2">		    
		...
		<div class="form-group">
		  <label for="special" class="col-sm-2 control-label">Especial?</label>
		  <div class="col-sm-2">		    
		...
		<div class="form-group">
		  <div class="col-sm-offset-2 col-sm-10">
		    ...
		    &nbsp;
		    <a href="${pageContext.request.contextPath}/addressStates" class="btn btn-default">Voltar</a>
		  </div>
		</div>
