...
public class AddressStateController {
	...
	private static final String deleteSuccessMsg = "Estado excluída com sucesso!";
	private static final String deleteErrorMsg = "Não foi possível excluir o estado!";
	private static final String saveSuccessMsg = "Estado salvo com sucesso!" ;
	private static final String saveErrorMsg = "Não foi possível salvar o estado!";
	private static final String locateErrorMsg = "Estado não localizado (ID: {})" ;
